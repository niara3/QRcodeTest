...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private void doSurfaceChanged(int width, int height) {
        ...
        if (!mSurfaceConfiguring) {
            ...
            mPreviewWidthRatio = (float)previewSize.width / (float)pictureSize.width;
            mPreviewHeightRatio = (float)previewSize.height / (float)pictureSize.height;
	...
	public void autoFocus(SampleQrActivity callback) {
        if (null == mCamera) {
            return;
        }
        try {
	...
	public float getPreviewWidthRatio() {
		return mPreviewWidthRatio;
	}
